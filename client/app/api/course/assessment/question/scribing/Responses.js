...
export default class ResponsesAPI extends BaseScribingAPI {
  /**
   * survey_response = {
  *   survey: {
  ...
  * }
   ...
   */
  create(scribingId) {
    return this.getClient().post(this._getUrlPrefix(scribingId));
  }
  ...
  *   }
  ...
  _getUrlPrefix(scribingId) {
    const id = scribingId || this.getScribingId();
    return `/courses/${this.getCourseId()}/assessments/${this.getAssessmentId()}/question/scribing/${id}/responses`;
  }
}
