...
class ScribingToolbar extends Component {
  ...
  enableTextSelection() {
    ...
    this.props.scribing.canvas.initializeScribbles(false);
    this.props.scribing.canvas.forEachObject(object => (
  ...
  addText = () => {
    ...
    this.props.scribing.canvas.add(new fabric.IText('Text', { // eslint-disable-line no-undef
      ...
      left: this.props.scribing.canvas.width / 2,
      top: this.props.scribing.canvas.height / 2,
    }));
  }
  ...
  render() {
    ...
    const lineToolStyle = {
      ...styles.custom_line,
      background: this.props.scribing.selectedTool === scribingTools.LINE ? 'black' : 'rgba(0, 0, 0, 0.4)',
    };
          ...
          <ToolDropdown
            ...
            popoverComponent={() => (
              <ShapePopover
                ...
                setSelectedShape={shape => (this.setSelectedShape(this.props.answerId, shape))}
